if (global.hasMod('butchercraft')) {
  ServerEvents.tags('item', (event) => {
    event.add('butchercraft:carcass', [
      '#butchercraft:big_carcass',
      '#butchercraft:small_carcass',
    ...
    event.add('butchercraft:rabbit_carcass/carcass', [
    ...
    event.add('butchercraft:big_carcass', [
    ...
    event.add('butchercraft:small_carcass', [
